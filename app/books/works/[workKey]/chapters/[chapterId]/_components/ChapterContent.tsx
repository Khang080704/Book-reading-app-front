                            ...
                            <div className="flex items-center gap-1.5">
                                {(Object.keys(FONT_FAMILIES) as FontFamily[]).map((key) => (
                                    <button
                                        ...
                                        className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-all ${fontFamily === key
                    ...
                    >
                        ...
                        <div className="flex gap-x-3">
                            <Button
                                ...
                                onClick={() => redirect(`/books/works/${encodeURIComponent(workKey)}/chapters/${chapter.prevChapterId}`)}
                            >
                                <ArrowLeft className="size-3.5" />
                                Chương Trước
                            </Button>

                            <Link href={`/books/works/${encodeURIComponent(workKey)}/resource/${chapter.resourceId}`}>
                                <Button
                                    variant="outline"
                                    size="sm"
                                    className="gap-2 mt-4"
                            ...
                            <Button
                                ...
                                onClick={() => redirect(`/books/works/${encodeURIComponent(workKey)}/chapters/${chapter.nextChapterId}`)}
                            >
                                Chương sau
